...
if (( $doComputeResolutions > 0 )); then
    ...
    ## python plot_resolutions_HCal.py --outDir $runname --doFits plot $runname/results.csv --all
    ...
    ## run this
    python plot_resolutions_HCal.py --outDir $runname --doFits compare clusters CaloClusters CalibratedCaloClusters $runname/results.csv --all
