...
ROOT::VecOps::RVec<std::vector<float>> getCaloCluster_energyInLayersHCal (const ROOT::VecOps::RVec<edm4hep::ClusterData>& in, const ROOT::VecOps::RVec<edm4hep::CalorimeterHitData>& cells, const int nLayers=12);
ROOT::VecOps::RVec<std::vector<float>> getCaloCluster_energyInLayersBoth (const ROOT::VecOps::RVec<edm4hep::ClusterData>& in, const ROOT::VecOps::RVec<edm4hep::CalorimeterHitData>& cells, const int nLayers=12, const int nLayersECal=11);
