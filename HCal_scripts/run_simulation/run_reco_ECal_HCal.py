...
hcalBarrelLayers = 13
hcalBarrelInvSamplingFraction = 27.42 # 27.42 is at 60 degrees 
hcalEndcapInvSamplingFraction = 27.42 # FIXME: to be updated for ddsim

# Benchmark parameters for combined ECal+HCal simulation
# ecalHcalBarrelBenchmarkParameters = [[2.4, 1.053, -5.27, 0.9503, -0.26, 0.0004]]
...
applyUpDownBenchmarkCorrections = True
...
def setupSWClusters(inputCells,
                    ...
                    outputClusters,
                    clusteringThreshold,
                    applyUpDownBenchmarkCorrections,
    ...
    if applyUpDownBenchmarkCorrections:
        ...
        correctClusterAlg = CorrectCaloClusters("Correct" + outputClusters,
                                                ...
                                                firstLayerIDs=[0,0],
                                                lastLayerIDs=[ecalBarrelLayers - 1,hcalBarrelLayers-1],
                                                readoutNames=[inputReadouts["ecalBarrel"],hcalBarrelReadoutName],
                                                ...
                                                ## below parameters and formulas for two functions with ene switch at 5~GeV, first term for high-ene, second for low-ene, the constant term is set to zero 
                                                # benchmarkParametrization = [[0.9723, 2.5101,      1.,   1.0601, -6.0609, -0.1451,  0.0007, -0.2741,  40.094, -4031.11, 100.45, 0.],[2.0527, 0.2767, -0.0672, 0.>
                                                # benchmarkFormulas        = [['[0]+[1]/sqrt(x)', '[0]', '[0]+[1]/(x+[2])',         '[0]+[1]/x',       '[0]+[1]/(x+[2])',      '[0]'],['[0]+[1]*x+[2]*x*x+[3]*x*x>
                                                #benchmarkEneSwitch = 5.,
                                                ## below parameters and formulas for one function (derireved in Nov 2023 with eta-phi segmentation)
