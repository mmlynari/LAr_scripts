...
if doSWClustering:
    towers = CaloTowerToolFCCee("towers",
                                ...
                                hcalBarrelReadoutName="",
                                hcalExtBarrelReadoutName=hcalEndcapReadoutName2,
    ...
    towers.hcalExtBarrelCells.Path = hcalEndcapPositionedCellsName2
