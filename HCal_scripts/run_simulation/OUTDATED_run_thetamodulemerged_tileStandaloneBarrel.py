...
addShapeParameters = False and not runHCal
...
detectors_to_use = [
    'FCCee/ALLEGRO/compact/ALLEGRO_o1_v03/ALLEGRO_o1_v03_tileStandalone.xml'
]
...
if runHCal:
    ...
    calibHcells = CalibrateCaloHitsTool(
        "CalibrateHCalBarrel", invSamplingFraction="30.3953")
    # HCal barrel at EM scale 30.3953
    # HCal barrel at HAD scale 35.2556
    # - HCAL endcap
    # calibHcalEndcap = CalibrateCaloHitsTool(
    #    "CalibrateHCalEndcap", invSamplingFraction="32.0630")
# endcap at hadronic scale 35.1272
# endcap 31.7 
...
if runECal: 
    ...
    ecalBarrelCellsName = "emptyCaloCells"
    ecalBarrelPositionedCellsName = "emptyCaloCells"
    ecalBarrelCellsName2 = "emptyCaloCells"
    ecalBarrelPositionedCellsName2 = "emptyCaloCells"
    cellPositionEcalBarrelTool = None
    cellPositionEcalBarrelTool2 = None
...
if runHCal:
    ...
    hcalEndcapCellsName = "emptyCaloCells"
    hcalEndcapPositionedCellsName = "emptyCaloCells"
    hcalEndcapCellsName2 = "emptyCaloCells"
...
if doSWClustering:
    towers = CaloTowerToolFCCee("towers",
                                ...
                                hcalFwdReadoutName="",
                                OutputLevel=INFO)
    towers.ecalBarrelCells.Path = "emptyCaloCells"
...
if not saveHits:
    ...
    out.outputCommands.append("drop HCalBarrelCells")
    out.outputCommands.append("drop HCalBarrelCellsWithoutRow")
...
out.filename = "./root/output_HCal_evts_" + str(Nevts) + "_pdg_" + str(pdgCode) + "_pMin_" + str(momentum) + "_GeV" + "_ThetaMinMax_" + str(thetaMin) + "_" + str(
...
if runHCal:
    ...
    #createHcalEndcapCells.AuditExecute = False
if doTopoClustering:
