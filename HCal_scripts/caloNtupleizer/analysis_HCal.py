...
parser.add_argument("-cellBranchNames", default = ["HCalBarrelPositionedCells2"], help="Name of the cell branch in the input rootfile. Must have position information!", type = str)
...
parser.add_argument("-genBranchName", type=str, default="genParticles",
...
parser.add_argument("-geometryFile", default=os.environ['K4GEO'] + '/FCCee/ALLEGRO/compact/ALLEGRO_o1_v03/ALLEGRO_o1_v03.xml', help="Path to the xml geometry file", type=str)
parser.add_argument("-readoutName", default='HCalBarrelReadout', help="Name of the readout to use for the layer/phi/theta bin definition", type=str)
