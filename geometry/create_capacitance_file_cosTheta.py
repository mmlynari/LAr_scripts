...
deltaCosTheta = 0.008
maxCosTheta = 0.71 # 45 degrees
numCosTheta = int(ceil(maxCosTheta/deltaCosTheta))
print(numEta)
#PCB dimensions [mm]
hhv = 0.1
hs = 0.17
...
for i in range (0, len(readoutLayerParallelLengths)):
    print("--------------")
    for index in range(0, numCosTheta):
        eta = index * deltaEta
        cosTheta = index * deltaCosTheta
