...
for i in range (0, nLayers):  
    ...
    h_elecNoise_fcc[i].SetTitle("Default electronic noise: shield + detector capacitance; |#eta|; Electronic noise [MeV]")
    ...
    h_elecNoise_all[i].SetTitle("Total electronic noise: shield + trace + detector capacitance; |#eta|; Electronic noise [MeV]")
    ...
    h_elecNoise_withTraceCap[i].SetBins(nbins, 0., etaMax)
    h_elecNoise_withTraceCap[i].SetTitle("Electronic noise with trace capacitance; |#eta|; Electronic noise [MeV]")
    ...
    h_elecNoise_shield[i].SetTitle("Electronic noise - shields; |#eta|; Electronic noise [MeV]")
    ...
    h_elecNoise_trace[i].SetTitle("Electronic noise -traces; |#eta|; Electronic noise [MeV]")
    ...
    h_elecNoise_detector[i].SetTitle("Electronic noise - detector; |#eta|; Electronic noise [MeV]")
