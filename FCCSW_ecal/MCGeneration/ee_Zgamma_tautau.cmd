...
Random:setSeed = on  ! see https://pythia.org/latest-manual/RandomNumberSeed.html
Random:seed = 44
...
WeakZ0:gmZmode = 0 ! (default = 0; minimum = 0; maximum = 2) Choice of full gamma^*/Z^0 structure or not in relevant processes. option 0 : full gamma^*/Z^0 structure, with interference included. option 1 : only pure gamma^* contribution. option 2 : only pure Z^0 contribution. 
23:onMode = off ! switch off all decay mode from the Z (pdg Id = 23)
23:onIfMatch = 15 -15 ! switch on the decay of Z to tau tau
