...
python condor_submit_fccsw.py -outputFolder /eos/user/b/brfranco/rootfile_storage/ -campaignName $(date +"%y%m%d")_condor_calib_10kEvt \
 -gaudiConfig $PWD/fcc_ee_samplingFraction_inclinedEcal.py -jobType samplingFraction \
 -energies 45000 50000 -polarAngles 90 -energiesForDifferentPolarAngles 10000 \
 -nEvt 10000 -originalNjobs 250 -pdgId 11 #--submit
